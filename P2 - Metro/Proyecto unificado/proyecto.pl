...
estacion(ni�os_heroes,19.41944444,-99.15055556).
...
estacion(pe�on_viejo,19.37333333,-99.01722222).
...
conexion(balderas, ni�os_heroes, 0.86). %verde
conexion(ni�os_heroes, hospital_general, 0.71). %verde
...
conexion(guelatao, pe�on_viejo,2.36).%morada
conexion(pe�on_viejo, acatitla, 1.56).%morada
